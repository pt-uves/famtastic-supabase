...
COMMENT ON TYPE  user_role                                 IS 'Platform-level account role. user = regular app user; platform_admin = web-portal super-admin.';
COMMENT ON COLUMN public.profiles.role                     IS 'Platform-level role. Defaults to user; set to platform_admin for web-portal super-admins by the platform team.';
